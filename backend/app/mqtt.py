...
class MQTT:
    ...
    sub_topics = [("620162688_pub", 0), ("620162688", 0), ("620162688_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620162688", self.update)
        #self.client.message_callback_add("620162688_sub", self.toggle)
